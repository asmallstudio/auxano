...
import DefaultTextArea from "components/ui/defaultTextArea/DefaultTextArea";
...
export default function Contact({ siteData, contact }) {
  return (
    <>
      <Head>
        <title>
...
export async function getStaticProps() {
  const contact = await import("data/pages/contact.json");

  return {
    props: { contact: contact.default },
  };
}
